            ...
            if self.enable_litm:
                ...
                if self.run_wandb:
                    if self.model.training:
                        print("train_model_loss: ", model_loss.item())
                        print("train_kl_loss: ", kl_loss.item())
                        print("train_kl_loss*mu: ", self.mu*kl_loss.item())
                        self.run_wandb.log({"train_model_loss":model_loss.item(), "train_kl_loss":kl_loss.item(), "train_mu_kl_loss":self.mu*kl_loss.item()})
                    else:
                        print("eval_model_loss: ", model_loss.item())
                        print("eval_kl_loss: ", kl_loss.item())
