...
def generate_batch_texts(prompts, model, tokenizer, max_length=4096):
    ...
    outputs = model.generate(**inputs, max_length=max_length, max_new_tokens=10)
...
def main(model_name, output_dir="results_metrics", filename="metrics"):
    ...
    eval_dataset = load_dataset("Paoloc99/dataset", split="test[:200]")
    ...
    save_metrics(metrics, output_dir, filenmame)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", type=str, required=True, help="The name or path of the model to use")
    ...
    main(model_name=args.model, output_dir=args.output_dir, filename=args.filename)